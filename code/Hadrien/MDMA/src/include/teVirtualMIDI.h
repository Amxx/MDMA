 ...
 * midiports on Windows (XP to 7, 32bit & 64bit).  The "back-end" of teVirtualMIDI which is defined
 * by this include file of teVirtualMIDI can be used to create & destroy such ports and receive and
 * transmit data from/to those created ports.
 *

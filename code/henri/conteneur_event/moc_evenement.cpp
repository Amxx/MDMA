...
**
** Created: Sun Oct 21 16:11:59 2012
...
static const char qt_meta_stringdata_Evenement[] = {
    "Evenement\0\0id,valeur\0detect_machin(int,int)\0"
    "_zone\0ajout_zone(Zone&)\0"
};
...
void Evenement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->detect_machin((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->ajout_zone((*reinterpret_cast< Zone(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject Evenement::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Evenement,
...
// SIGNAL 0
void Evenement::detect_machin(int _t1, int _t2)
{
